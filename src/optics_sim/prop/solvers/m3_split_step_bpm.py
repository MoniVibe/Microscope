...
class M3SplitStepBPMSolver:
    ...
    def __init__(
        ...
        **kwargs
        ...
        logger.info(f"M3 Split-Step BPM solver initialized")
    ...
    def propagate(
        ...
        n_profile: Optional[Callable] = None
    ) -> torch.Tensor:
        """
        ...
        logger.debug(f"M3 Split-step: z={z_distance*1e3:.1f} mm, steps={self.n_steps}, dz={dz*1e6:.1f} μm")
