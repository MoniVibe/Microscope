...
from optics_sim.prop.solvers import bpm_vector_wide, bpm_split_step_fourier, as_multi_slice
from optics_sim.validation.cases import gaussian_free_space
from optics_sim.validation.metrics import l2_field_error, energy_conservation
...
def test_multi_step_propagation():
    ...
    E0, Ez_analytical = gaussian_free_space(
        wavelength_um, waist_um, total_z, nx, ny, dx, dy
    )
