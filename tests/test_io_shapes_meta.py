...
from optics_sim.io.tiff import write_tiff, read_tiff, write_field_stack
...
def test_io_shapes_meta():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            assert data_read.shape == data_real.shape, f"Shape mismatch: {data_read.shape} vs {data_real.shape}"
